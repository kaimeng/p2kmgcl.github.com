...
p2kmgcl.modules.cheatList = function ()  {
    var template = '<article class="cheatList">\
                ...
                <ul>\
                    ...
                    <li>Puedes usar las distintas redes sociales .pablomolina.me para acceder a mis perfiles web (por ejemplo: <a href="http://googleplus.pablomolina.me">googleplus.pablomolina.me</a>).</li>\
                </ul>\
            </article>',
        $el = $(template);
